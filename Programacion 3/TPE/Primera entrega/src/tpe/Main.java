//para cambiar entre agregar al principio se debe cambiar 2 lineas las cuales estan señaladas
package tpe;
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(csvFile))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                Integer id= Integer.parseInt(items[0]);
                	...
                	l.agregarUltimo(id, gustos);//1/2 puede usar agregarElemento o agregarUltimo
            }
        } 
        catch (IOException e) {
            e.printStackTrace();
        	...
        	BufferedWriter bw = null;
      		try {
      			...
      			while ((line = br.readLine()) != null) {
                	...
                	l.agregarUltimo(id, gustos);//2/2 puede usar agregarElemento o agregarUltimo
                	cantidad++;
    	   ...
    	   BufferedWriter bw = null;
      		try {
	            ...
	            while ((line = br.readLine()) != null) {
	        		...
	        		startTime = System.nanoTime();
	        		String[] items = line.split(cvsSplitBy);
	        		if(l.buscarEnLista(Integer.parseInt(items[0]))){
